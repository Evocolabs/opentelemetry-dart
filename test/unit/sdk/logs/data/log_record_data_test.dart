...
void main() {
  ...
  test('LogRecord add attributes with limits exceeded', () {
    ...
    final logRecordData = _createLogRecordData()
      ..withLimits(LogRecordLimits.create(attributeCountLimit: 3, attributeValueLengthLimit: 3))
      ..addAttribute(Attribute.fromInt('test', 1))
      ..addAttribute(Attribute.fromString('testTruncation', '1234'))
      ..addAttribute(Attribute.fromStringList('testTruncationOfAttrs', ['1234', '12345', '12345']))
      ...
      expect(logRecordData.attributesCollection.get('testTruncationOfAttrs'), ['123', '123', '123']);
